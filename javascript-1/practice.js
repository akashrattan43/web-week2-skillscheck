...
// Code Here
var total = myNumbers.reduce((acc, num) => acc += num)
//////////////////PROBLEM 17////////////////////
...
// Code Here
var forTheLoveOfGeorge = notGeorge.map((x, y) => {
	if (x !== "George"){
		return (x = "George")
	}
})
...
// Code Here
var totallyAwesome = people.reduce((j, i) =>{
	return j + i.awesomeLevel
}, 0)